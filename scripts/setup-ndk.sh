...
# Installs NDK r27 to /opt/android-ndk if cross-compiler not found
set -euo pipefail
...
echo "Cross-compiler: $TOOLCHAIN_DIR/aarch64-linux-android-clang"
