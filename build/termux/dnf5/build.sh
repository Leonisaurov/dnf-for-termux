...
cmake -S "$SOURCE_DIR" -B "$BUILD_DIR" \
  ...
  -DWITH_COMPS=ON \
  -DCMAKE_EXE_LINKER_FLAGS="-L$RPM_STAGING/lib -L$LIBSOLV_STAGING/lib -L$LIBREPO_STAGING/lib -L$LIBCOMPS_STAGING/lib -L$ZCHUNK_STAGING/lib -Wl,-rpath-link,$RPM_STAGING/lib -Wl,-rpath-link,$LIBSOLV_STAGING/lib -Wl,-rpath-link,$LIBREPO_STAGING/lib -Wl,-rpath-link,$LIBCOMPS_STAGING/lib -Wl,-rpath-link,$ZCHUNK_STAGING/lib" \
  -DCMAKE_SHARED_LINKER_FLAGS="-L$RPM_STAGING/lib -L$LIBSOLV_STAGING/lib -L$LIBREPO_STAGING/lib -L$LIBCOMPS_STAGING/lib -L$ZCHUNK_STAGING/lib" \
  2>&1
