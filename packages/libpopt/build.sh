...
# REVISION 4: paquete parcheado del overlay (termux-no-elevated-exec-drop.patch)
# > el oficial 1.19-3 de termux-main; evita SIGSYS en execCommand() al no
# soltar privilegios cuando euid==uid y egid==gid (seccomp de Android).
